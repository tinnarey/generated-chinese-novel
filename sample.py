...
tf.flags.DEFINE_string('converter_path', 'model/novel/converter.pkl', 'model/name/converter.pkl')
tf.flags.DEFINE_string('checkpoint_path', 'model/novel', 'checkpoint path')
