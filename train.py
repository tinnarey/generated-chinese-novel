...
tf.flags.DEFINE_string('name', 'novel', 'name of the model')
tf.flags.DEFINE_integer('num_seqs', 32, 'number of seqs in one batch')
tf.flags.DEFINE_integer('num_steps', 80, 'length of one seq')
...
tf.flags.DEFINE_string('input_file', 'data/novel.txt', 'utf8 encoded text file')
